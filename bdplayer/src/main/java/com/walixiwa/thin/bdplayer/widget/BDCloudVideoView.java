 ...
 */
package com.walixiwa.thin.bdplayer.widget;
...
public class BDCloudVideoView extends FrameLayout implements MediaController.MediaPlayerControl {
    ...
    public interface OnPlayerStateListener {
         void onPlayerStateChanged(final PlayerState nowState);
    }
    ...
    private Handler mainThreadHandler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == MESSAGE_CHANGE_CACHING) {
                if (onCachingStateChangeListener1 != null) {
                    onCachingStateChangeListener1.onCachingStateChange(msg.arg1 == 1);
                }
            }
        }
    };

    private OnCachingStateChangeListener onCachingStateChangeListener1;

    public void setOnCachingStateChangeListener(OnCachingStateChangeListener onCachingStateChangeListener) {
        onCachingStateChangeListener1 = onCachingStateChangeListener;
    }

    public interface OnCachingStateChangeListener {
        void onCachingStateChange(boolean b);
    }
...
//            mTargetState = STATE_ERROR;
    ...
    public com.baidu.cloud.media.player.misc.a[] getTrack() {
    ...
    public int getSelectedTrack() {
        return mMediaPlayer.getSelectedTrack(2);
    }
...
//                    Log.d(TAG, "onBufferingUpdate: percent=" + percent);
    ...
    public long getDownloadSpeed() {
        if (mMediaPlayer != null) {
           /* if (cachingProgressHint != null && cachingHintViewRl.getVisibility() == VISIBLE) {
                cachingProgressHint.setText("正在缓冲:" + convertFileSize(mMediaPlayer.getDownloadSpeed()) + "/s");
            }*/
